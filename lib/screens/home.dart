...
class _HomeState extends State<Home> {
  ...
  Future<void> loadData() async {
    ...
    await Future.delayed(
        const Duration(seconds: 3)); // For example, a 1-second delay
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                Stack(
                                  children: [
                                    Container(
                                      ...
                                      height: 60,
                                      color:
                                          const Color.fromRGBO(15, 103, 180, 1),
                                    ),
                                  ],
                                ),
                                Stack(children: [
                                ...
                                Container(
                                  color:
                                      const Color.fromRGBO(16, 103, 180, 0.1),
                                  child: Padding(
